...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-checkaberrantvalue", sprintf("Check if aberrant value are detected and if so, kill bitcoind"),DEFAULT_ABERRANT_VALUE,OptionsCategory::NODE_RELAY);
